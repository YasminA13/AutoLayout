...
//    CGRect blueBoxFrame = CGRectMake(50, 50, 50, 50);
//    
//    UIView *blueBox = [[UIView alloc] initWithFrame:blueBoxFrame];
//    blueBox.backgroundColor = [UIColor blueColor];
//    //    blueBox.backgroundColor = [UIColor colorWithRed:0xFF/255.0 green:1 blue:0 alpha:1];
//    blueBox.alpha = 0.5;
    
//    CGRect purpleBoxFrame = CGRectZero;
//    
//    UIView *purpleBox = [[UIView alloc] initWithFrame:purpleBoxFrame];
//    framingView.translatesAutoresizingMaskIntoConstraints = NO;
//    framingView.backgroundColor = [UIColor purpleColor];
//    [self.view addSubview:framingView];
//    self.framingView = framingView;
